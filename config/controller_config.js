module.exports = [
    ...
    {id:8, type:'path', path:'/nas/list', method:['post'], file:'nas-controller', func:'getList'},
    {id:9, type:'path', path:'/nas/upload', method:['post'], file:'nas-controller', func:'upload', upload:true},
];